    ...
    <div className="app app--newsletter">
      <main className="newsletter" style={{ display: "flex", flexDirection: "column" }}>
        ...
        {window.SUMO_DATA && (() => {
          ...
          const youngProspects = SUMO.YOUNG_PROSPECTS || [];
                    ...
                    {(GOLF.LAST_MAJOR.podium || []).map((row, i) => (
                      <div key={`${row.rank}-${row.name}`} className="newsletter-row newsletter-row--dual-score">
                        ...
                        <span className="newsletter-row__score">
                          ...
                          <span className="newsletter-row__score-value">{row.nivel != null ? row.nivel : "—"}</span>
                        </span>
                        <span className="newsletter-row__score">
                          <span className="newsletter-row__score-label">Leyenda</span>
                          <span className="newsletter-row__score-value">{row.legend != null ? row.legend : "—"}</span>
                        </span>
                        <span className="newsletter-row__score">
